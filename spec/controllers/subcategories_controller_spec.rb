...
RSpec.describe SubcategoriesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested subcategory as @subcategory" do
      subcategory = Subcategory.create! valid_attributes
      get :show, params: {id: subcategory.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested subcategory as @subcategory" do
      subcategory = Subcategory.create! valid_attributes
      get :edit, params: {id: subcategory.to_param}, session: valid_session
      expect(assigns(:subcategory)).to eq(subcategory)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Subcategory" do
        expect {
          post :create, params: {subcategory: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved subcategory as @subcategory" do
        post :create, params: {subcategory: invalid_attributes}, session: valid_session
        expect(assigns(:subcategory)).to be_a_new(Subcategory)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested subcategory" do
        subcategory = Subcategory.create! valid_attributes
        put :update, params: {id: subcategory.to_param, subcategory: new_attributes}, session: valid_session
        subcategory.reload
      ...
      it "assigns the requested subcategory as @subcategory" do
        subcategory = Subcategory.create! valid_attributes
        put :update, params: {id: subcategory.to_param, subcategory: valid_attributes}, session: valid_session
        expect(assigns(:subcategory)).to eq(subcategory)
      end
    ...
    context "with invalid params" do
      it "assigns the subcategory as @subcategory" do
        subcategory = Subcategory.create! valid_attributes
        put :update, params: {id: subcategory.to_param, subcategory: invalid_attributes}, session: valid_session
        expect(assigns(:subcategory)).to eq(subcategory)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested subcategory" do
      subcategory = Subcategory.create! valid_attributes
      expect {
        delete :destroy, params: {id: subcategory.to_param}, session: valid_session
      }.to change(Subcategory, :count).by(-1)
    end
